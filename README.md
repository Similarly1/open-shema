...
* **Interopérabilité Totale** :
  ...
  * Consultez la documentation complète : [Spécification Technique des Fichiers Markdown Enrichis](https://github.com/Similarly1/open-shema/blob/main/docs/SPECIFICATION_MARKDOWN.md) pour comprendre la structure exacte des en-têtes Frontmatter, des cartes mentales radiantes, du catalogue des 121 icônes vectorielles SVG et des manuscrits de prédication.
* **🎨 Système Universel d'Icônes Vectorielles SVG (121 Symboles Nobles)** :
  * Catalogue de 121 symboles vectoriels théologiques et bibliques (100% SVG purs, zéro émoji, trait harmonisé, adaptatifs clair/sombre via `currentColor`), utilisables en ligne dans vos notes (`::croix::`, `::bible::`, `::cite::`, `::tour::`) et sur vos cartes mentales (branches et thème central), épaulés par un moteur de suggestions sémantiques instantané (100% local, sans LLM).
