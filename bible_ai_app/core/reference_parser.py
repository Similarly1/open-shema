...
BOOK_MAPPING_RAW = {
    ...
    "rois": "1Ki", "kings": "1Ki", "roi": "1Ki", "king": "1Ki",
    ...
    "chroniques": "1Ch", "chronicles": "1Ch", "chron": "1Ch",
    ...
    "nahum": "Nah", "na": "Nah", "nah": "Nah", "nam": "Nah", "nahoum": "Nah",
    "habacuc": "Hab", "habakuk": "Hab", "ha": "Hab", "hab": "Hab", "habakkuk": "Hab", "habaquq": "Hab",
    ...
    "1 timothee": "1Ti", "1ti": "1Ti", "1tim": "1Ti", "1 tim": "1Ti", "1 tm": "1Ti", "1tm": "1Ti", "1 timothy": "1Ti",
    "2 timothee": "2Ti", "2ti": "2Ti", "2tim": "2Ti", "2 tim": "2Ti", "2 tm": "2Ti", "2tm": "2Ti", "2 timothy": "2Ti",
...
def parse_bible_search_query(query: str):
    ...
    Gère toutes les syntaxes possibles:
    - 'rm 4', 'Rm 4', 'rm4', 'romains 4', 'Romains 4', 'ro 4', 'rom 4'
    - '1co 13', '1 co 13', '1 corinthiens 13', '1cor 13', '1co13'
    - '2 timothee 2', '2 tm 2', '2ti 2', '2 tim 2', '2tm 2'
