...
const s1End = html.indexOf('</div></div>', html.indexOf('<div class="article-footnotes-section">'));
const s2Start = html.indexOf('<div class="article-footnotes-section">', s1End);

console.log("=== CONTENT BETWEEN SECTIONS ===");
console.log(html.substring(s1End, s2Start + 50));
