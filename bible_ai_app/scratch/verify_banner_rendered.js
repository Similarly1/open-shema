...
const md = fs.readFileSync('C:/Users/adrie/Documents/antigravity/peaceful-mendeleev/bible_ai_app/data/articles/content/e21/e21_01f94487bfb9.md', 'utf8');
const html = articlesView.renderMarkdown(md);

const bannerIdx = html.indexOf('<div class="article-editors-note-banner">');
console.log("=== RENDERED BANNER HTML ===");
console.log(html.substring(bannerIdx, bannerIdx + 300));
